...
const translations = {
    en: {
        ...
        "story.concept": "We envisioned a reimagined Belgian 🇧🇪 cuisine built around a unique concept: loaded fries topped with great Belgian classics",
        "story.concept_end": "reinterpreted with precision and creativity.",
        "story.recipes": "Vol-au-vent, beef cheeks, Liège-style meatballs, moules-frites… and much more: each recipe was created, tested, and perfected over nearly two years, alongside experienced chefs.",
        ...
        "story.quality": "At Fritzguard, everything is homemade, with no frozen products, using only fresh, local, and 100% Belgian 🇧🇪 ingredients.",
        ...
        "story.content": "Born in 2022, in the heart of Brussels, facing the Bourse, Fritzguard Brussels is a family passion project.<br><br>We envisioned a reimagined Belgian 🇧🇪 cuisine built around a unique concept: loaded fries topped with great Belgian classics, reinterpreted with precision and creativity.<br><br>Vol-au-vent, beef cheeks, Liège-style meatballs, moules-frites… and much more: each recipe was created, tested, and perfected over nearly two years, alongside experienced chefs.<br><br>Our menu also features premium burgers made with quality Angus beef and chicken, as well as vegetarian alternatives such as our cauliflower burgers, to satisfy every taste.<br><br>At Fritzguard, everything is homemade, with no frozen products, using only fresh, local, and 100% Belgian 🇧🇪 ingredients.<br><br>Designed in collaboration with renowned designers and architects, the project combines authenticity, modernity, and craftsmanship.<br><br>Today, Fritzguard has become a must-visit address in Brussels, with the ambition to grow while never betraying its DNA: quality above all.",

        // Menu Section
        "menu.label": "Menu",
        "menu.title": "signature dishes",
        "menu.button": "discover full menu",
        "menu.description": "Vol-au-vent, beef cheeks, Liège-style meatballs, moules-frites… and much more: each recipe was created, tested, and perfected over nearly two years, alongside experienced chefs.\n\nOur menu also features premium burgers made with quality Angus beef and chicken, as well as vegetarian alternatives such as our cauliflower burgers, to satisfy every taste.",
        ...
        "jobs.paragraph2": "At Fritzguard, we don't just serve frites—we serve an experience. Join us and be part of a team that's dedicated to perfecting every detail, from sourcing the finest Belgian 🇧🇪 ingredients to delivering exceptional service to our guests.",
    ...
    nl: {
        ...
        "story.title": "Het Beste van België",
        ...
        "story.concept": "We bedachten een vernieuwde Belgische 🇧🇪 keuken rond een uniek concept: frietjes beladen met grote Belgische klassieken",
        "story.concept_end": "opnieuw geïnterpreteerd met precisie en creativiteit.",
        "story.recipes": "Vol-au-vent, runderangen, Luikse balletjes, moules-frites… en nog veel meer: elk recept werd bijna twee jaar lang gecreëerd, getest en geperfectioneerd, samen met ervaren chefs.",
        ...
        "story.quality": "Bij Fritzguard is alles huisgemaakt, zonder bevroren producten, met alleen verse, lokale en 100% Belgische 🇧🇪 ingrediënten.",
        ...
        "story.content": "Opgericht in 2022, in het hart van Brussel, tegenover de Beurs, is Fritzguard Brussel een familiepassieproject.<br><br>We bedachten een vernieuwde Belgische 🇧🇪 keuken rond een uniek concept: frietjes beladen met grote Belgische klassieken, opnieuw geïnterpreteerd met precisie en creativiteit.<br><br>Vol-au-vent, runderangen, Luikse balletjes, moules-frites… en nog veel meer: elk recept werd bijna twee jaar lang gecreëerd, getest en geperfectioneerd, samen met ervaren chefs.<br><br>Ons menu bevat ook premiumburgers van kwaliteit Angus-rundvlees en kip, evenals vegetarische alternatieven zoals onze bloemkoolburgers, om elke smaak tevreden te stellen.<br><br>Bij Fritzguard is alles huisgemaakt, zonder bevroren producten, met alleen verse, lokale en 100% Belgische 🇧🇪 ingrediënten.<br><br>Ontworpen in samenwerking met gerenommeerde ontwerpers en architecten, combineert het project authenticiteit, moderniteit en vakmanschap.<br><br>Vandaag is Fritzguard een must-visit-adres in Brussel geworden, met de ambitie om te groeien zonder zijn DNA te verraden: kwaliteit bovenal.",

        // Menu Section
        "menu.label": "Menu",
        "menu.title": "signature gerechten",
        "menu.button": "ontdek volledige menu",
        "menu.description": "Vol-au-vent, runderangen, Luikse balletjes, moules-frites… en nog veel meer: elk recept werd bijna twee jaar lang gecreëerd, getest en geperfectioneerd, samen met ervaren chefs.\n\nOns menu bevat ook premiumburgers van kwaliteit Angus-rundvlees en kip, evenals vegetarische alternatieven zoals onze bloemkoolburgers, om elke smaak tevreden te stellen.",

        // Jobs Section
        "jobs.heading": "Vacatures",
        "jobs.title": "Sluit Je Bij Ons Team Aan",
        "jobs.paragraph1": "We zoeken altijd naar gepassioneerde personen die ons engagement voor excellentie en kwaliteit delen. Of je nu chef bent, keukenmedewerker, server of onderdeel van ons team, we geloven in het creëren van een omgeving waarin iedereen kan groeien en floreren.",
        "jobs.paragraph2": "Bij Fritzguard serveren we niet zomaar frites—we serveren een ervaring. Sluit je bij ons aan en maak deel uit van een team dat zich inzet voor het perfectioneren van elk detail, van het zoeken van de fijnste Belgische 🇧🇪 ingrediënten tot het leveren van uitzonderlijke service aan onze gasten.",
    ...
    fr: {
        ...
        "nav.contact": "Collaboration",
        "nav.order": "Réserver une table",
        "nav.logo_sub_title": "L'Ordre du Goût",
        ...
        "story.founding": "Fondée en 2022",
        "story.location": "au cœur de Bruxelles, face à la Bourse, Fritzguard Bruxelles est un projet passionnel familial.",
        "story.concept": "Nous avons imaginé une cuisine belge 🇧🇪 réinventée construite autour d'un concept unique : des frites chargées garnie de grands classiques belges",
        "story.concept_end": "réinterprétés avec précision et créativité.",
        "story.recipes": "Vol-au-vent, joues de bœuf, boulettes à la liégeoise, moules-frites… et bien d'autres : chaque recette a été créée, testée et perfectionnée pendant près de deux ans, aux côtés de chefs expérimentés.",
        "story.burgers": "Notre menu propose également des burgers premium à base de bœuf Angus de qualité et de poulet, ainsi que des alternatives végétariennes comme nos burgers au chou-fleur, pour satisfaire tous les palais.",
        "story.quality": "Chez Fritzguard, tout est fait maison, sans produits surgelés, en utilisant uniquement des ingrédients frais, locaux et 100% belges 🇧🇪.",
        "story.design": "Conçu en collaboration avec des designers et architectes renommés, le projet combine authenticité, modernité et artisanat.",
        "story.today": "Aujourd'hui, Fritzguard est devenu une adresse incontournable de Bruxelles, avec l'ambition de grandir sans jamais trahir son ADN : la qualité avant tout.",
        "story.content": "Fondée en 2022, au cœur de Bruxelles, face à la Bourse, Fritzguard Bruxelles est un projet passionnel familial.<br><br>Nous avons imaginé une cuisine belge 🇧🇪 réinventée construite autour d'un concept unique : des frites chargées garnie de grands classiques belges, réinterprétés avec précision et créativité.<br><br>Vol-au-vent, joues de bœuf, boulettes à la liégeoise, moules-frites… et bien d'autres : chaque recette a été créée, testée et perfectionnée pendant près de deux ans, aux côtés de chefs expérimentés.<br><br>Notre menu propose également des burgers premium à base de bœuf Angus de qualité et de poulet, ainsi que des alternatives végétariennes comme nos burgers au chou-fleur, pour satisfaire tous les palais.<br><br>Chez Fritzguard, tout est fait maison, sans produits surgelés, en utilisant uniquement des ingrédients frais, locaux et 100% belges 🇧🇪.<br><br>Conçu en collaboration avec des designers et architectes renommés, le projet combine authenticité, modernité et artisanat.<br><br>Aujourd'hui, Fritzguard est devenu une adresse incontournable de Bruxelles, avec l'ambition de grandir sans jamais trahir son ADN : la qualité avant tout.",

        // Menu Section
        "menu.label": "Menu",
        "menu.title": "plats signature",
        "menu.button": "découvrir le menu complet",
        "menu.description": "Vol-au-vent, joues de bœuf, boulettes à la liégeoise, moules-frites… et bien d'autres : chaque recette a été créée, testée et perfectionnée pendant près de deux ans, aux côtés de chefs expérimentés.\n\nNotre menu propose également des burgers premium à base de bœuf Angus de qualité et de poulet, ainsi que des alternatives végétariennes comme nos burgers au chou-fleur, pour satisfaire tous les palais.",

        // Jobs Section
        "jobs.heading": "Emplois",
        "jobs.title": "Rejoignez Notre Équipe",
        "jobs.paragraph1": "Nous recherchons toujours des individus passionnés qui partagent notre engagement envers l'excellence et la qualité. Que vous soyez chef, personnel de cuisine, serveur ou membre de notre équipe, nous croyons en la création d'un environnement où chacun peut s'épanouir.",
        "jobs.paragraph2": "Chez Fritzguard, nous ne servons pas que des frites—nous servons une expérience. Rejoignez-nous et faites partie d'une équipe dévouée à perfectionner chaque détail, de l'approvisionnement des plus beaux ingrédients belges 🇧🇪 à la prestation d'un service exceptionnel à nos clients.",
        ...
        // Footer
        "footer.year": "Tous droits réservés",
        "footer.contact": "Contact",
        "footer.followUs": "Suivez-nous",

        // Accessibility
        "video.noSupport": "Votre navigateur ne supporte pas la balise vidéo."
    }
};
...
function setupLanguageSwitcher() {
    ...
    if (langSwitchers.length === 0) {
        console.warn('⚠️ Language switcher elements not found in DOM');
...
function updateActiveLangButton() {
    ...
    if (langButtons.length === 0) {
        console.warn('⚠️ No language buttons found to update');
        return;
    }
    ...
    langButtons.forEach((button) => {
        ...
        if (buttonLang === currentLang) {
            ...
            foundActive = true;
            console.log('✓ Added .active class to button:', buttonLang);
        }
    });
